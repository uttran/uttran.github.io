...
suspend fun fetchSource(): List<Thirukkural> {
    val sourceUrl = "https://raw.githubusercontent.com/dreamuth/dreamuth.github.io/master/resources/thirukkural.json"
    val sourceData = window.fetch(sourceUrl).await().text().await()
    val groupsUrl = "https://raw.githubusercontent.com/dreamuth/dreamuth.github.io/master/kids/resources/kids-group-2022-23.json"
